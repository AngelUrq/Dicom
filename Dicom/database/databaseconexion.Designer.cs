...
{
	partial class databaseconexion
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.sqlview.Location = new System.Drawing.Point(293, 239);
			this.sqlview.Name = "sqlview";
			this.sqlview.Size = new System.Drawing.Size(240, 150);
			this.sqlview.TabIndex = 1;
			this.sqlview.CellContentClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.dataGridView1_CellContentClick);
			// 
			// databaseconexion
			// 
			...
			this.Name = "databaseconexion";
			this.Text = "databaseconexion";
			this.Load += new System.EventHandler(this.databaseconexion_Load);
